...
class SubsetServerRequestTest extends TestCase
{
    public function test__construct()
    {
        $this->assertInstanceOf(SubsetServerRequest::class, new SubsetServerRequest('GET', [], [
            'x-test' => [
                'X-Test' => [
                    'foo',
                    'bar',
    ...
    {
        $headerReader = new SubsetServerRequest('POST', [], $headers, '0.9');
    ...
    {
        $headerReader = new SubsetServerRequest('PATCH', [], $headers, '1.0');
     ...
     * @param string   $expectGetHeaderLine
     */
    public function testGetHeaderLine(array $headers, $testHeaderName, $expectHas, $expectGetHeader,
                                      $expectGetHeaderLine
    )
    {
        $headerReader = new SubsetServerRequest('HEAD', [], $headers, '1.1');
    ...
    {
        $headerReader = new SubsetServerRequest('OPTIONS', [], [], 'any string will work - no validation');
        $this->assertSame('any string will work - no validation', $headerReader->getProtocolVersion());
    }

    public function testGetMethod()
    {
        $headerReader = new SubsetServerRequest('any string will work - no validation',[], [], '0.9');
    ...
    {
        $headerReader = new SubsetServerRequest('DELETE', [], $constructorHeaders, '1.1');
